...
class ObatController extends Controller
{
    ...
    public function showData(){
        ...
        $dataPembeli = Nota::select(DB::raw("users.nama as nama, SUM(notas.total_harga) as jumlah"))->join('users','notas.user_id','=','users.id')->groupBy("user_id")->orderBy("jumlah","DESC")->take(3)->get();
        dd($dataPembeli);
    }
