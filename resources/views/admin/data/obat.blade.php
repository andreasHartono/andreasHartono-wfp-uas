            ...
            <div class="card">
                                ...
                                <form method="POST" action="{{ url('/obat/add') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="price" type="number" placeholder="Masukan Harga Obat"
                                                class="form-control">
                                        </div>
                                        <div class="form-group">
                ...
                <div class="table-responsive">
                    <table id="default-datatable"
                        class="table dataTable align-items-center table-flush table-hover table-striped">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>Nama</th>
                            ...
                            @foreach ($data as $data)
                                <tr>
                                    ...
                                    <td><img width="200px" height="100px"
                                            src="{{ asset('/images/obat/' . $data->gambar) }}" alt=""></td>
                                    <td>Rp.{{ $data->harga }}</td>
                                    <td>{{ $data->kategori->nama }}</td>
                                    <td>
                                        <a href="" class="btn btn-warning" data-toggle="modal"
                                            data-target="#exampleModal2{{ $data->id }}">Ubah Obat</a>

                                        <div class="modal fade" id="exampleModal2{{ $data->id }}" tabindex="-1"
                                            role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">Update Data Obat
                                                        </h5>
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input name="image" type="file"
                                                                    value="{{ $data->gambar }}" class="form-control"
                                                                    id="image">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="exampleInputEmail1">Harga Obat</label><br>
                                                                <input name="price" value="{{ $data->harga }}"
                                                                    type="number" placeholder="Masukan Harga Obat"
                                                                    class="form-control">
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Kategori</label>
                                        ...
                                        <form action="{{ url('/obat/delete/' . $data->id) }}" method="POST">
                                            ...
                                            <button type="submit" class="btn btn-danger"
                                                onclick="if(!confirm('Apakah anda yakin menghapus data {{ $data['nama'] }}')) return false">Hapus
                                                Obat</button>
                                        </form>
                                    </td>
                                </tr>
